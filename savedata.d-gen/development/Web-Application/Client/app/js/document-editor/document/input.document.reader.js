...
export class InputDocumentReader {
    constructor() {
        ...
        this.mode = "normal";
        this.form = document.querySelector("#frm-form-handler");
        this.txtFormInput = document.querySelector("#frm-form-handler-txt-input");
        this.cmbWaySelector = document.querySelector("#frm-form-handler-select-way");
    ...
    StartExport() {
        ...
        [ReportBox, PreviewBoxBody].forEach((bx) => {
            if (bx.hasAttribute("data-function") &&
        ...
        if (this.mode == "markdown-text") {
            ...
            Sdp.ITS = this.EData;
            var container = document.querySelector("#localstore-server-api");
            container.innerHTML = "";
            container.appendChild(new CodeBlock(Sdp.RenderApi(), "typescript").element);
...
//# sourceMappingURL=input.document.reader.js.map